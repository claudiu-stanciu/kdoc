...
#echo "spark.executor.extraClassPath /opt/nifi/oracle/*:$SPARK_HOME/lib/mysql-connector-java-5.1.41.jar:/usr/local/spark/lib/ojdbc.jar" >> $SPARK_HOME/conf/spark-defaults.conf
echo "spark.driver.extraClassPath $SPARK_HOME/lib/*" >> $SPARK_HOME/conf/spark-defaults.conf
