...
echo "spark.executor.extraClassPath $SPARK_HOME/lib/mysql-connector-java-5.1.41.jar:$SPARK_HOME/lib/ojdbc.jar" >> $SPARK_HOME/conf/spark-defaults.conf
echo "spark.driver.extraClassPath $SPARK_HOME/lib/mysql-connector-java-5.1.41.jar:$SPARK_HOME/lib/ojdbc.jar" >> $SPARK_HOME/conf/spark-defaults.conf
